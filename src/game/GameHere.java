...
public class GameHere extends StateBasedGame{
    ...
    public static final int LEVEL_04 = 5;
    public static final int LEVEL_05 = 6;
    ...
    public GameHere(String name)
    {
      ...
      //  this.addState(new TestLevel(DEMO_LEVEL));
        ...
        this.addState(new Level_03(LEVEL_03));
        this.addState(new Level_04(LEVEL_04));
        this.addState(new Level_05(LEVEL_05));
    }
    ...
    public void initStatesList(GameContainer gc) throws SlickException {
        ...
        this.getState(LEVEL_03).init(gc, this);
        this.getState(LEVEL_04).init(gc, this);
        this.getState(LEVEL_05).init(gc, this);
